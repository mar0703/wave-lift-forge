...
export const DICT: Record<Lang, Record<string, string>> = {
  en: {
    ...
    onboarding_subtitle: "Set up your profile to personalize training",
    onboarding_step1: "Athlete Profile",
    onboarding_step2: "Fatigue & Readiness",
    onboarding_step3: "Energy Level",
    onboarding_step4: "Recovery Speed",
    onboarding_step5: "Psychological Type",
    onboarding_fatigue_desc: "How tired the athlete feels after training or daily stress. Affects recovery and training load tolerance.",
    onboarding_readiness_desc: "Ability to perform high-quality training today based on recovery, sleep, and fatigue.",
    onboarding_energy_desc: "Current subjective energy available for training output.",
    onboarding_recovery_speed_desc: "How quickly athlete returns to baseline after training.",
    onboarding_psych_desc: "Behavioral response under stress (calm / aggressive / anxious).",
    onboarding_complete: "Complete Onboarding",
    onboarding_skip: "Skip for now",
    onboarding_success: "Profile configured → regenerating session...",
  },
  pl: {
    ...
    stress_calm: "Spokój",
    onboarding_title: "Onboarding zawodnika",
    onboarding_subtitle: "Skonfiguruj profil, aby spersonalizować trening",
    onboarding_step1: "Profil zawodnika",
    onboarding_step2: "Zmęczenie i gotowość",
    onboarding_step3: "Poziom energii",
    onboarding_step4: "Szybkość regeneracji",
    onboarding_step5: "Typ psychologiczny",
    onboarding_fatigue_desc: "Jak bardzo zmęczony czuje się zawodnik po treningu lub codziennym stresie. Wpływa na regenerację i tolerancję obciążenia.",
    onboarding_readiness_desc: "Zdolność do wykonania wysokiej jakości treningu dziś, na podstawie regeneracji, snu i zmęczenia.",
    onboarding_energy_desc: "Aktualny subiektywny poziom energii dostępny do treningu.",
    onboarding_recovery_speed_desc: "Jak szybko zawodnik wraca do stanu wyjściowego po treningu.",
    onboarding_psych_desc: "Reakcja behawioralna na stres (spokój / agresja / niepokój).",
    onboarding_complete: "Zakończ onboarding",
    onboarding_skip: "Pomiń na razie",
    onboarding_success: "Profil skonfigurowany → regenerowanie sesji...",
  },
  ru: {
    ...
    onboarding_title: "Онбординг атлета",
    onboarding_subtitle: "Настройте профиль для персонализации тренировок",
    onboarding_step1: "Профиль атлета",
    onboarding_step2: "Усталость и готовность",
    onboarding_step3: "Уровень энергии",
    onboarding_step4: "Скорость восстановления",
    onboarding_step5: "Психологический тип",
    onboarding_fatigue_desc: "Насколько уставшим чувствует себя атлет после тренировки или повседневного стресса. Влияет на восстановление и переносимость нагрузки.",
    onboarding_readiness_desc: "Способность выполнять качественную тренировку сегодня на основе восстановления, сна и усталости.",
    onboarding_energy_desc: "Текущий субъективный уровень энергии, доступный для тренировки.",
    onboarding_recovery_speed_desc: "Как быстро атлет возвращается к исходному состоянию после тренировки.",
    onboarding_psych_desc: "Поведенческая реакция на стресс (спокойствие / агрессия / тревожность).",
    onboarding_complete: "Завершить онбординг",
    onboarding_skip: "Пропустить",
    onboarding_success: "Профиль настроен → перегенерация сессии...",
  },
};
