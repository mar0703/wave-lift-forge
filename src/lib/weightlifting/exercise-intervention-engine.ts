...
const CATALOG: ExerciseIntervention[] = [
  ...
  // ---------------- integrated stage ----------------
  {
    ...
    target_phases: ["second_pull", "turnover"],
  ...
  // ---------------- strength / pulls (adaptation, high cost) ----------------
  {
    ...
    target_phases: ["first_pull", "second_pull"],
    coordination_cost: 25,
    cns_cost: 75,
  ...
  // ---------------- competition specific ----------------
  {
    ...
    target_phases: ["first_pull", "second_pull", "turnover", "catch", "recovery"],
  ...
  },
  {
    ...
    intervention_purpose: "adaptation",
    target_problems: ["specificity_decay"],
    target_phases: ["first_pull", "second_pull", "turnover", "catch", "recovery", "dip", "drive"],
  ...
  },
  {
    ...
    target_phases: ["transition", "second_pull", "turnover"],
    coordination_cost: 25,
    cns_cost: 20,
    technical_transfer: 60,
    specificity_score: 40,
